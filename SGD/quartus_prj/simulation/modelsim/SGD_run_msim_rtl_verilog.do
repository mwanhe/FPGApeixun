...
vlog -vlog01compat -work work +incdir+D:/001shixun/SGD/rtl {D:/001shixun/SGD/rtl/SGD.v}

vlog -vlog01compat -work work +incdir+D:/001shixun/SGD/quartus_prj/../sim {D:/001shixun/SGD/quartus_prj/../sim/SGD_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  SGD_tb
