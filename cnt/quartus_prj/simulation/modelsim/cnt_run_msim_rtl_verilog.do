...
vlog -vlog01compat -work work +incdir+D:/001shixun/cnt/rtl {D:/001shixun/cnt/rtl/cnt.v}

vlog -vlog01compat -work work +incdir+D:/001shixun/cnt/quartus_prj/../sim {D:/001shixun/cnt/quartus_prj/../sim/cnt_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  cnt_tb
